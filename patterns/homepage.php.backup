<?php
/**
 * Title: Homepage Layout – VTS
 * Slug: vogelsang-vts/homepage
 * Categories: layout
...
register_block_pattern(
  ...
  [
    ...
    'categories'  => ['layout'],
    'content'     =>
'<!-- wp:group {"align":"full","className":"bg-vts-primary text-white","layout":{"type":"constrained"}} -->
    ...
    <div class="wp-block-columns are-vertically-aligned-center items-center gap-8 lg:gap-12">
      ...
      <div class="wp-block-column is-vertically-aligned-center" style="flex-basis:45%">
        ...
        <figure class="wp-block-image rounded-lg shadow-2xl w-full">
          <img src="' . esc_url(get_template_directory_uri() . '/assets/hero-data-wave.jpg') . '" alt="Data visualization representing technology excellence"/>
        </figure>
        <!-- /wp:image -->
      </div>
      <!-- /wp:column -->
